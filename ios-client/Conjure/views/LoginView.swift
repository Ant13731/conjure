...
//                 "Connection Result: Malformed input http://\(ip_address):\(port)/offer: Please check IP address and port"
//             return
//         }
...
//                     if let err = err {
//                         connectionResultMessage =
//                             "Connection Result: Failed to send URL connection request: \(err)"
//                         return
//                     }

//                     guard let data = data else {
//                         connectionResultMessage =
//                             "Connection Result: Failed to get URL response. Got \(data)"
//                         return
//                     }
//                     guard
...
//                         connectionResultMessage =
//                             "Connection Result: Failed to parse URL response. Got \(data_str)"
//                         return
//                     }
...
//                     else {
//                         connectionResultMessage =
//                             "Connection Result: Expected fields `sdp` and `type` are not in the json response: \(json)"
//                         return
//                     }
