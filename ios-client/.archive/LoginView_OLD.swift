...
//                }
    ...
    func depthToGrayscale(depthBuffer: CVPixelBuffer, minDepth: Float16 = 0.1, maxDepth: Float16 = 1.5) -> CVPixelBuffer? {
        ...
        for y in 0..<height {
                ...
                for x in 0..<width {
                    ...
                    let scaledValue = UInt32(((value - minDepth) / (maxDepth - minDepth)) * pow(2.0, 3*8))
                    
//                    let clampedDepth = ((value - minDepth) / (maxDepth - minDepth))
